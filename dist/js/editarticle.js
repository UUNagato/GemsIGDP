$(document).ready(function(){
    ...
    $('#articletitle').val(window.localStorage.getItem('edittitle'));
    $('#summernote').summernote('code',window.localStorage.getItem('editcontent'));
})
...
function onSubmitClick() {
    ...
    // all comfirmed
    $.ajax({
        url:'/articleList/editarticle',
        method:'POST',
        data:{
            id:window.localStorage.getItem('editid'),
            title:title,
            content:text},
        cache:false,
        dataType:'json',
